...
public partial class CiPlatformContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        ...
        => optionsBuilder.UseSqlServer("Data Source=PCA112\\SQL2019; Initial Catalog=CI-Platform; user id=sa; password=Tatva@123; TrustServerCertificate=True; Trusted_Connection=True;");
