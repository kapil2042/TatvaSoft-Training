...
!(function (t) {
    ...
    (function (t) {
                ...
                (e.prototype = {
                    ...
                    moveToRight: function (e, o, i, n) {
                        ...
                        return "function" == typeof r.callbacks.moveToRight
                            ...
                            : "function" != typeof r.callbacks.beforeMoveToRight ||
                                i ||
                                r.callbacks.beforeMoveToRight(r.$left, r.$right, e)
                                ? (e.each(function (e, o) {
                                    var i = t(o);
                                    if (r.options.ignoreDisabled && i.is(":disabled"))
                                        return !0;
                                    if (i.parent().is("optgroup")) {
                                        var n = i.parent(),
                                            l = r.$right.find(
                                                'optgroup[label="' + n.prop("label") + '"]'
                                            );
                                        l.length || ((l = n.clone()), l.children().remove()),
                                            (i = l.append(i)),
                                            n.removeIfEmpty();
                                    }
                                    r.$right.move(i);
                                    ...
                                    "function" != typeof r.callbacks.sort ||
                                    i ||
                                    r.$right.mSort(r.callbacks.sort),
                                    "function" != typeof r.callbacks.afterMoveToRight ||
                                    i ||
                                    r.callbacks.afterMoveToRight(r.$left, r.$right, e),
                                    r)
                                : !1;
                    },
                    moveToLeft: function (e, o, i, n) {
                        ...
                        return "function" == typeof r.callbacks.moveToLeft
                            ...
                            : "function" != typeof r.callbacks.beforeMoveToLeft ||
                                i ||
                                r.callbacks.beforeMoveToLeft(r.$left, r.$right, e)
                                ? (e.each(function (e, o) {
                                    var i = t(o);
                                    if (i.is("optgroup") || i.parent().is("optgroup")) {
                                        ...
                                        l.length || ((l = n.clone()), l.children().remove()),
                                            (i = l.append(i.is("optgroup") ? i.children() : i)),
                                            n.removeIfEmpty();
                                    }
                                    r.$left.move(i);
                                }),
                                    ...
                                    "function" != typeof r.callbacks.sort ||
                                    i ||
                                    r.$left.mSort(r.callbacks.sort),
                                    "function" != typeof r.callbacks.afterMoveToLeft ||
                                    i ||
                ...
                startUp: function (t, e) {
                    e.find("option").each(function (e, o) {
                        var i = t.find('option[value="' + o.value + '"]'),
                            n = i.parent();
                        i.remove(),
                            "OPTGROUP" == n.prop("tagName") && n.removeIfEmpty();
                    });
                },
        ...
        var o = window.navigator.userAgent,
            i =
                o.indexOf("MSIE ") + o.indexOf("Trident/") + o.indexOf("Edge/") >
                -3;
